...
if (window.location.pathname.includes("interiores.html")) {
  ...
  items = [
    ...
    { src: '../img/proyecto3_demo.jpg', desc: 'Apartamento Aurora: Renovación de un piso antiguo con alma contemporánea, donde conviven lo clásico y lo funcional con equilibrio.' },
    ...
    { src: '../img/proyecto5_demo.jpg', desc: 'Loft Urbano: Espacio industrial reconvertido en vivienda moderna, con estructura vista, amplitud y carácter metropolitano.' },
    { src: '../img/proyecto6_demo.png', desc: 'Cabaña Forestal: Diseño sostenible en plena naturaleza, con madera local, eficiencia energética y conexión con el entorno.' },
    { src: '../img/proyecto7_demo.jpg', desc: 'Galería Prisma: Espacio expositivo con iluminación escenográfica, pensado para realzar obras y generar experiencias visuales.' },
    { src: '../img/proyecto8_demo.jpg', desc: 'Café Boutique: Interiorismo cálido con materiales naturales, mobiliario artesanal y atmósfera acogedora para encuentros tranquilos.' }
  ];
}
  ...
  items = [
    ...
    { src: '../img/cortinas_demo.png', desc: 'Cortinas de lino natural que filtran la luz suavemente, creando ambientes luminosos, serenos y de textura ligera y envolvente.' },
    ...
    { src: '../img/lamparamesa_demo.jpg', desc: 'Diseño compacto y luz ambiental suave que complementa escritorios o mesillas con funcionalidad y estilo.' }
  ];
  ...
  items = [
    ...
    { src: '../img/estanteria_demo.jpg', desc: 'Estantería modular que permite reorganizarla según las necesidades del espacio. Diseño versátil, funcional y de líneas contemporáneas.' },
    { src: '../img/lampara_demo.jpg', desc: 'Lámpara de pie con luz regulable, estructura esbelta y acabado sobrio. Aporta funcionalidad y equilibrio visual al entorno.' },
    { src: '../img/sofa_demo.jpg', desc: 'Sofá moderno tapizado en lino gris, con líneas suaves y proporciones equilibradas. Ofrece confort y presencia sin excesos.' },
    { src: '../img/comoda_demo.jpg', desc: 'Cómoda nórdica en madera clara, de formas puras y diseño funcional. Aporta orden visual y calidez sin sobrecargar el espacio.' }
  ];
}
